    ...
    >
      ...
      {isOpen && (
        <div className={`p-4 ${isSynthwaveMode ? "digital-rain" : ""}`}>
          ...
          <Accordion
            type="multiple"
            defaultValue={["projects", "relationships"]}
            className="space-y-2"
          >
            <AccordionItem
              value="projects"
              className={`border-border ${isSynthwaveMode ? "neon-border" : ""}`}
            >
              <AccordionTrigger
                className={`py-2 ${
                  isSynthwaveMode
                  ...
                  {uniqueProjects.map((project) => (
                    <div key={project} className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={() =>
                          toggleFilter("projects", project)
                        }
                        className={
                          isSynthwaveMode ? "border-cyan-500 text-pink-500" : ""
                        }
                      />
                      <Label
            ...
            >
              ...
              >
                <div className="flex items-center">
                  <CheckCircle
                    className={`mr-2 h-4 w-4 ${isSynthwaveMode ? "text-teal-300" : "text-green-500"}`}
                  />
                  Status
                </div>
              </AccordionTrigger>
            ...
            >
              ...
              >
                <div className="flex items-center">
                  <AlertTriangle
                    className={`mr-2 h-4 w-4 ${isSynthwaveMode ? "text-pink-300" : "text-amber-500"}`}
                  />
                  Priority
                </div>
              </AccordionTrigger>
                  ...
                  {uniquePriorities.map((priority) => (
                    <div key={priority} className="flex items-center space-x-2">
                      ...
                      <Label
                        ...
                        className="flex items-center text-sm text-foreground"
                      >
                        <Badge className={`mr-2 ${getPriorityColor(priority)}`}>
                          {priority}
                        </Badge>
                      </Label>
                    </div>
            ...
            >
              ...
              >
                <div className="flex items-center">
                  <Tag
                    className={`mr-2 h-4 w-4 ${isSynthwaveMode ? "text-yellow-300" : "text-yellow-500"}`}
                  />
                  Labels
                </div>
              </AccordionTrigger>
            ...
            >
              ...
              >
                <div className="flex items-center">
                  <GitBranch
                    className={`mr-2 h-4 w-4 ${isSynthwaveMode ? "text-purple-300" : "text-purple-500"}`}
                  />
                  Relationships
                </div>
              </AccordionTrigger>
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        onFilterChange({ showOnlyParents: !!checked })
                      }
                      className={
                        isSynthwaveMode ? "border-cyan-500 text-pink-500" : ""
                      }
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        onFilterChange({ showOnlyChildren: !!checked })
                      }
                      className={
                        isSynthwaveMode ? "border-cyan-500 text-pink-500" : ""
                      }
