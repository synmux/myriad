...
!((a, b) => {
        ...
        return (
          (Number.parseFloat(Ma(a, "marginLeft")) ||
            a.getBoundingClientRect().left -
              ca(a, { marginLeft: 0 }, () => a.getBoundingClientRect().left)) +
          "px"
        );
    })),
  ...
  (r.extend({
    ...
    ajaxSetup: (a, b) =>
      b ? Lb(Lb(a, r.ajaxSettings), b) : Lb(r.ajaxSettings, a),
    ajaxPrefilter: Jb(Fb),
    ajaxTransport: Jb(Gb),
    ajax: (b, c) => {
  ...
  (r.ajaxSetup({
      ...
      return (
        ...
        this.length > 0 &&
          r
            ...
            .done((a) => {
              ((f = arguments),
                this.html(d ? r("<div>").append(r.parseHTML(a)).find(d) : a));
            })
            .always(
              c &&
                ((a, b) => {
    ...
    (r.expr.pseudos.animated = (a) =>
      r.grep(r.timers, (b) => a === b.elem).length));
  function Sb(a) {
