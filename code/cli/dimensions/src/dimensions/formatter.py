...
class OutputFormatter:
    ...
    def _generate_summary(
        ...
        filtered_results: List[DimensionStats],
    ) -> Dict:
        """
        Generate summary statistics.
        ...
        return {
            ...
            "most_common_dimension": (
                most_common.dimensions_str if most_common else "None"
            ),
    ...
    def _output_text_format(
        ...
        """
        output_console = (
            Console(file=open(output_file, "w", encoding="utf-8"))
            if output_file
            else Console()
        )
    ...
    def show_progress_summary(
        self, total_processed: int, total_failed: int, processing_time: float
    ) -> None:
        """
