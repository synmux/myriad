...
class DirectoryScanner:
    ...
    def scan_directory(self, directory: Path) -> Iterator[Path]:
        ...
        try:
            ...
            self.logger.error("Permission denied accessing directory", 
    ...
    def _scan_recursive(self, directory: Path) -> Iterator[Path]:
        ...
        try:
            ...
            self.logger.warning("Cannot access directory", 
                              directory=str(directory), error=str(e))
        ...
        for entry in entries:
            try:
                ...
                self.logger.warning("Cannot access file/directory", 
                                  path=str(entry), error=str(e))
    ...
    def count_images(self, directory: Path) -> int:
        ...
        try:
            ...
            self.logger.error("Error counting images", 
                            directory=str(directory), error=str(e))
