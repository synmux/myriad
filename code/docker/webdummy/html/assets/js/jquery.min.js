...
!((a, b) => {
  ...
  ;(r.fn = r.prototype =
    ...
    r.extend({
      ...
      isNumeric: (a) => {
        var b = r.type(a)
        return ("number" === b || "string" === b) && !isNaN(a - Number.parseFloat(a))
      },
      isPlainObject: (a) => {
        var b, c
        return (
      ...
      type: (a) =>
        null == a ? a + "" : "object" == typeof a || "function" == typeof a ? j[k.call(a)] || "object" : typeof a,
      globalEval: (a) => {
        p(a)
      },
    ...
    r.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "), (a, b) => {
  ...
  var x = ((a) => {
    var b,
      ...
      ca = (a, b) =>
        b ? ("\0" === a ? "\ufffd" : a.slice(0, -1) + "\\" + a.charCodeAt(a.length - 1).toString(16) + " ") : "\\" + a,
      da = () => {
        m()
      },
      ea = ta((a) => a.disabled === !0, { dir: "parentNode", next: "legend" })
    try {
        ...
        (a) => {
          ...
          return g !== n && 9 === g.nodeType && g.documentElement
            ? ((n = g),
              ...
              (c.getById = ja(
                (a) => ((o.appendChild(a).id = u), !n.getElementsByName || !n.getElementsByName(u).length)
              )),
              c.getById
                ? ((d.find.ID = (a, b) => {
      ...
      (d = ga.selectors =
        {
          ...
          filter: {
            ...
            PSEUDO: (a, b) => {
              ...
              return e[u]
                ...
                : e.length > 1
                  ? ((c = [a, a, "", b]),
                    Object.hasOwn(d.setFilters, a.toLowerCase())
                      ? ia((a, c) => {
                          var d,
                            f = e(a, b),
                            g = f.length
          ...
          pseudos: {
            ...
            contains: ia(
              (a) => ((a = a.replace(_, aa)), (b) => (b.textContent || b.innerText || e(b)).indexOf(a) > -1)
            ),
            lang: ia(
              (a) => (
            ...
            root: (a) => a === o,
            focus: (a) => a === n.activeElement && (!n.hasFocus || n.hasFocus()) && !!(a.type || a.href || ~a.tabIndex),
            enabled: oa(!1),
            disabled: oa(!0),
            checked: (a) => {
  ...
  var y = (a, b, c) => {
    ...
    C = /^.[^:#[.,]*$/
  function D(a, b, c) {
    if (r.isFunction(b)) return r.grep(a, (a, d) => !!b.call(a, d, a) !== c)
    if (b.nodeType) return r.grep(a, (a) => (a === b) !== c)
    if ("string" == typeof b) {
      if (C.test(b)) return r.filter(b, a, c)
      b = r.filter(b, a)
    }
    return r.grep(a, (a) => i.call(b, a) > -1 !== c && 1 === a.nodeType)
  }
  ;(r.filter = (a, b, c) => {
    var d = b[0]
    return (
  ...
  var S = (a, b, c, d, e, f, g) => {
      ...
      if ("object" === r.type(c)) {
        ...
        ((e = !0),
        r.isFunction(d) || (g = !0),
        j && (g ? (b.call(a, d), (b = null)) : ((j = b), (b = (a, b, c) => j.call(r(a), c)))),
        b)
      )
    ...
    if (void 0 === c && 1 === a.nodeType)
      if (((d = "data-" + b.replace(Y, "-$&").toLowerCase()), (c = a.getAttribute(d)), "string" == typeof c)) {
        try {
          c =
            "true" === c ||
            ("false" !== c && ("null" === c ? null : +c + "" === c ? +c : X.test(c) ? JSON.parse(c) : c))
        } catch (e) {}
        W.set(a, b, c)
      } else c = void 0
    return c
  ...
  r.extend({
    ...
    r.fn.extend({
      ...
      promise: function (a, b) {
        ...
        while (g--) (c = V.get(this[g], a + "queueHooks")), c && c.empty && (d++, c.empty.add(h))
          ...
          if (1 === i.nodeType && (i.disabled !== !0 || "click" !== a.type)) {
            for (d = [], c = 0; c < h; c++)
              (f = b[c]),
                (e = f.selector + " "),
                void 0 === d[e] &&
                  (d[e] = f.needsContext ? r(e, this).index(i) > -1 : r.find(e, this, null, [i]).length),
                d[e] && d.push(f)
        ...
        ? (a && a.type
            ? ((this.originalEvent = a),
              ...
              (this.isDefaultPrevented =
                a.defaultPrevented || (void 0 === a.defaultPrevented && a.returnValue === !1) ? ta : ua),
  ...
  function Ha(a, b, c, d) {
    ...
    if (
      m &&
      ((e = oa(b, a[0].ownerDocument, !1, a, d)), (f = e.firstChild), 1 === e.childNodes.length && (e = f), f || d)
    ) {
  ...
  r.extend({
    htmlPrefilter: (a) => a.replace(xa, "<$1></$2>"),
    clone: (a, b, c) => {
      var d,
        e,
        f,
  ...
  function Wa(a, b, c) {
    ...
    if ((a.getClientRects().length && (d = a.getBoundingClientRect()[b]), d <= 0 || null == d)) {
      ...
      ;(e = g && (o.boxSizingReliable() || d === a.style[b])), (d = Number.parseFloat(d) || 0)
    }
  ...
  r.extend({
    ...
    css: (a, b, c, d) => {
      ...
      return (
        ...
        "" === c || c ? ((f = Number.parseFloat(e)), c === !0 || isFinite(f) ? f || 0 : e) : e
      )
    }
  }),
    ...
    (r.cssHooks.marginLeft = Na(o.reliableMarginLeft, (a, b) => {
      if (b)
        return (
          (Number.parseFloat(Ma(a, "marginLeft")) ||
            a.getBoundingClientRect().left - ca(a, { marginLeft: 0 }, () => a.getBoundingClientRect().left)) + "px"
        )
    })),
      ...
      propHooks: {
        tabIndex: {
          get: (a) => {
            ...
            return b ? Number.parseInt(b, 10) : jb.test(a.nodeName) || (kb.test(a.nodeName) && a.href) ? 0 : -1
          }
        }
      },
  ...
  r.fn.extend({
    ...
    r.each(["radio", "checkbox"], function () {
      ;(r.valHooks[this] = {
        ...
        o.checkOn || (r.valHooks[this].get = (a) => (null === a.getAttribute("value") ? "on" : a.value))
    })
  ...
  r.extend({
    ...
    (r.expr.pseudos.visible = (a) => !!(a.offsetWidth || a.offsetHeight || a.getClientRects().length)),
    (r.ajaxSettings.xhr = () => {
      try {
      ...
      return (
        ...
        this.length > 0 &&
          r
            ...
            .done((a) => {
              ;(f = arguments), this.html(d ? r("<div>").append(r.parseHTML(a)).find(d) : a)
            })
            .always(
              c &&
                ((a, b) => {
  ...
  ;(r.offset = {
    ...
    r.each(["top", "left"], (a, b) => {
      r.cssHooks[b] = Na(o.pixelPosition, (a, c) => {
