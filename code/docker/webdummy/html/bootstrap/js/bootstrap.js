    ...
    (() => {
      ...
      _proto._slide = function _slide(direction, element) {
        ...
        if ($(this._element).hasClass(ClassName$2.SLIDE)) {
          ...
          var nextElementInterval = Number.parseInt(nextElement.getAttribute("data-interval"), 10)
    ...
    (() => {
      ...
      _proto._getOffset = function _getOffset() {
        ...
        if (typeof this._config.offset === "function") {
          offset.fn = (data) => {
            data.offsets = _objectSpread({}, data.offsets, this._config.offset(data.offsets, this._element) || {})
            return data
          }
        } else {
        ...
        if (this._isBodyOverflowing) {
          ...
          $(fixedContent).each((index, element) => {
            ...
            $(element)
              ...
              .css("padding-right", Number.parseFloat(calculatedPadding) + this._scrollbarWidth + "px")
          ...
          $(stickyContent).each((index, element) => {
            ...
            $(element)
              ...
              .css("margin-right", Number.parseFloat(calculatedMargin) - this._scrollbarWidth + "px")
          }) // Adjust body padding
    ...
    (() => {
      ...
      _proto._getOffset = function _getOffset() {
        ...
        if (typeof this.config.offset === "function") {
          offset.fn = (data) => {
            data.offsets = _objectSpread({}, data.offsets, this.config.offset(data.offsets, this.element) || {})
            return data
          }
        } else {
      ...
      _proto._setListeners = function _setListeners() {
        ...
        triggers.forEach((trigger) => {
          if (trigger === "click") {
            ...
            var eventIn = trigger === Trigger.HOVER ? this.constructor.Event.MOUSEENTER : this.constructor.Event.FOCUSIN
            var eventOut =
